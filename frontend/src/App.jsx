  ...
  return (
    <Router>
      ...
      <Routes>
        ...
        <Route path="/admin-tasks" element={isAuthenticated() && userRole() === "admin" ? <AdminTasks /> : <Navigate to="/login" />} />
        <Route path="/dashboards" element={isAuthenticated() && userRole() === "admin" ? <Dashboard /> : <Navigate to="/login" />} />
      </Routes>
    </Router>
  );
}
